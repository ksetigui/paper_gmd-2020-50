 ...
 198          continue
  ...
  if(NSCAN.ne.0) then
    IF (iprt) then
        ...
        call wrf_message(msg)
    ENDIF
    call wrf_error_fatal3("module_fddaobs_rtfdda.b",1706,&
...
552               FORMAT('kpblt is gt 25, inest,i,j,kpblt=',4i4)
 ...
 326          continue
              ...
              if(nlevs_ob(n+nsndlev-1).ne.lev_in_ob(n+nsndlev-1)) then
                ...
                ENDIF
                call wrf_error_fatal3("module_fddaobs_rtfdda.b",2243,&
'wrf_fddaobs_in: in4dob' )
             endif       
...
170 CONTINUE
  ...
  elseif (var.eq.'mois') then
    ...
    call wrf_error_fatal3("module_fddaobs_rtfdda.b",2909,&
'print_vif_var: module_fddaobs_rtfdda STOP' )
  ...
  elseif (reg.eq.4) then
     ...
     call wrf_message(msg1)
     call wrf_error_fatal3("module_fddaobs_rtfdda.b",2948,&

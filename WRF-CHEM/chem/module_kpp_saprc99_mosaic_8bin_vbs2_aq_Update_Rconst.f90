...
REAL(KIND=dp), INTENT(IN) :: nume,den
  ...
  RCONST(204) = (ARR(9.40D-12,700.0_dp,0.0_dp,TEMP))
  ...
  RCONST(218) = (ARR(2.00D-14,4400.0_dp,0.0_dp,TEMP))
  RCONST(219) = (ARR(4.85D-12,-504.0_dp,0.0_dp,TEMP))
  RCONST(220) = (ARR(5.51D-15,1878.0_dp,0.0_dp,TEMP))
  RCONST(221) = (ARR(4.59D-13,1156.0_dp,0.0_dp,TEMP))
  RCONST(222) = (ARR(1.18D-11,324.0_dp,0.0_dp,TEMP))
  RCONST(223) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.13268_dp))
  RCONST(224) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.01401_dp,0.0_dp))
  RCONST(225) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.02875_dp,0.0_dp))
  RCONST(226) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.03833_dp,0.0_dp))
  RCONST(227) = (Keff2(2.640D-11,nume,den,0.0_dp,0.12739_dp))
  RCONST(228) = (Keff2(2.640D-11,nume,den,0.01231_dp,0.0_dp))
  RCONST(229) = (Keff2(2.640D-11,nume,den,0.00934_dp,0.0_dp))
  RCONST(230) = (Keff2(2.640D-11,nume,den,0.04756_dp,0.0_dp))
  RCONST(231) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.00109_dp))
  RCONST(232) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.00518_dp,0.00518_dp))
  RCONST(233) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.01717_dp,0.00872_dp))
  RCONST(234) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.01853_dp,0.14986_dp))
  RCONST(235) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.10845_dp,0.05450_dp))
  RCONST(236) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.09264_dp))
  RCONST(237) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.01020_dp))
  RCONST(238) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.99144_dp,0.65688_dp))
  RCONST(239) = (Keff(7.86D-15,1912.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.00327_dp))
  RCONST(240) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.00327_dp,0.02616_dp))
  RCONST(241) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.00872_dp))
  RCONST(242) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.13134_dp,0.14114_dp))
  RCONST(243) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.00490_dp,0.03917_dp))
  RCONST(244) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.01306_dp))
  RCONST(245) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.19666_dp,0.21134_dp))
  RCONST(246) = (Keff3(3.03D-12,448.0_dp,0.0_dp,TEMP,0.00027_dp))
  RCONST(247) = (Keff3(3.03D-12,448.0_dp,0.0_dp,TEMP,0.04060_dp))
  RCONST(248) = (Keff3(3.03D-12,448.0_dp,0.0_dp,TEMP,0.06458_dp))
  RCONST(249) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.17493_dp))
  RCONST(250) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.59019_dp))
  RCONST(251) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.26194_dp))
  RCONST(252) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.88373_dp))
  RCONST(253) = (ARR2(9.6e-12_dp,234._dp,TEMP))
  RCONST(254) = (usr24(temp,c_m))
  RCONST(255) = (ARR2(1.9e-13_dp,-520._dp,TEMP))

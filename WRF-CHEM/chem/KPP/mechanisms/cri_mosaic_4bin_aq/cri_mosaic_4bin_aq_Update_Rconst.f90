...
! Time                 : Mon Feb 27 11:08:36 2017
! Working directory    : /data/ksetigui/setigui/WRFV3_171015/chem/KPP/mechanisms/cri_mosaic_4bin_aq
...
! End INLINED RCONST
  ...
  RCONST(119) = (TROE(7.00D-31,2.6_dp,1.50D-11,0.5_dp,TEMP,C_M))
  ...
  RCONST(138) = (RJPL(1.D-28,0.8_dp,8.8D-12,0._dp,C_H2O,TEMP))
  RCONST(139) = (RALKE(8.D-27,3.5_dp,3.D-11,0.5_dp,C_M,TEMP))
  ...
  RCONST(165) = (0.364*K48(TEMP,C_M))
  RCONST(166) = (0.636*K48(TEMP,C_M))

...
SUBROUTINE setup_gasprofile_maps(chem_opt, numgas)
  ...
  case (CBMZ, CBMZ_BB, CBMZ_BB_KPP, CBMZ_SORGAM_KPP, &
        CBMZ_MOSAIC_KPP, CBMZ_MOSAIC_4BIN, CBMZ_MOSAIC_4BIN_VBS2_KPP, &
        CBMZ_MOSAIC_8BIN_VBS9_KPP, CBMZ_MOSAIC_4BIN_VBS9_KPP, &
  ...
  case (MOZART_MOSAIC_4BIN_VBS0_KPP)
     call wrf_debug("setup_profile_maps: nothing done for mozart_mosaic_4bin_vbs0__kpp")
    ...
    REAL :: olit
     if( nch .NE. num_chem) then
      ...
      CASE (CBMZ,CBMZ_BB,CBMZ_BB_KPP, CBMZ_MOSAIC_KPP, &
            CBMZ_MOSAIC_4BIN,CBMZ_MOSAIC_8BIN,CBMZ_MOSAIC_4BIN_VBS2_KPP, &
            CBMZ_MOSAIC_4BIN_AQ,CBMZ_MOSAIC_8BIN_AQ, &
            CBMZ_SORGAM_KPP, CBMZ_MOSAIC_8BIN_VBS9_KPP,CBMZ_MOSAIC_4BIN_VBS9_KPP, &
   ...
   real, INTENT (IN) :: g,rcp,t0,p1000mb
      ...
      if ((ic .ge. p_so2) .and. (ic .le. p_ho2)) then
        ...
        if (config_flags%chem_opt == RACM_KPP .or. &
            ...
            config_flags%chem_opt == RACM_ESRLSORG_AQCHEM_KPP ) then
          i_bdy_method = 9
        end if
  ...
  END SUBROUTINE bdy_chem_value_gcm
   ...
   integer FUNCTION get_last_gas(chem_opt)
     ...
     case (RADM2, RADM2_KPP, RADM2SORG, RADM2SORG_AQ, RADM2SORG_AQCHEM, RADM2SORG_KPP, &
        ...
        get_last_gas = p_ho2
     case (CBMZ_MOSAIC_4BIN_VBS2_KPP, SAPRC99_KPP,SAPRC99_MOSAIC_4BIN_VBS2_KPP, &
           SAPRC99_MOSAIC_4BIN_VBS9_KPP,SAPRC99_MOSAIC_8BIN_VBS2_AQ_KPP,SAPRC99_MOSAIC_8BIN_VBS2_KPP )
        get_last_gas = p_ch4
     case (CBMZ,CBMZ_MOSAIC_DMS_4BIN,CBMZ_MOSAIC_DMS_8BIN,CBMZ_MOSAIC_DMS_4BIN_AQ,CBMZ_MOSAIC_DMS_8BIN_AQ)
        get_last_gas = p_mtf
     case (CBMZ_BB,CBMZ_BB_KPP, CBMZ_SORGAM_KPP, CBMZ_MOSAIC_KPP, CBMZ_MOSAIC_4BIN, &

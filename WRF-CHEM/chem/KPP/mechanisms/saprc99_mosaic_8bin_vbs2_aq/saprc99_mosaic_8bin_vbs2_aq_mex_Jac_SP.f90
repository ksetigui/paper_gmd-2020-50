...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 USE saprc99_mosaic_8bin_vbs2_aq_Model
      ...
      REAL(kind=dp) V(92), F(2), RCT(255)
      REAL(kind=dp) JVS(1109)
...
! Check for the right number of output arguments
     ...
     &JVS(1109)')
      ...
      plhs(1) = mxCreateDoubleMatrix(1109,1,0)

      VPtr = mxGetPr(prhs(1))
      CALL mxCopyPtrToReal8(VPtr,V,92)
      
      FPtr = mxGetPr(prhs(2))
      CALL mxCopyPtrToReal8(FPtr,F,2)
      
      RPtr = mxGetPr(prhs(3))
      CALL mxCopyPtrToReal8(RPtr,RCT,255)

      JVSPtr = mxGetPr(plhs(1))

      CALL Jac_SP( V, F, RCT, JVS )

      CALL mxCopyReal8ToPtr(JVS, JVSPtr, 1109)

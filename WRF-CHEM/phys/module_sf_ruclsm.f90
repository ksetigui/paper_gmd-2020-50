 ...
 330      RHSMC(K+1)=(SOILMOIS(KN)+Q2*RHSMC(K)                             &
  ...
  10   I1=I
   ...
   1   PRINT *,'     AVOST IN VILKA      '
       ...
       CALL wrf_error_fatal3("module_sf_ruclsm.b",5123,&
'  Crash in surface energy budget  ' )
 ...
 IF(.not.restart)THEN
   ...
   IF ( errflag .EQ. 1 ) THEN
      CALL wrf_error_fatal3("module_sf_ruclsm.b",5699,&
  ...
  END SUBROUTINE ruclsminit
       ...
       IF ( wrf_dm_on_monitor() ) THEN
        ...
        IF(ierr .NE. OPEN_OK ) THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",5835,&
message )
        END IF
 ...
 2002   CONTINUE
    ...
    ENDIF
        ...
        IF (LUMATCH == 0) then
           CALL wrf_error_fatal3("module_sf_ruclsm.b",5906,&
"Land Use Dataset '"//MMINLURUC//"' not found in VEGPARM.TBL.")
      ...
      IF ( wrf_dm_on_monitor() ) THEN
        ...
        IF(ierr .NE. OPEN_OK ) THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",5942,&
message )
        END IF
 ...
 2003   CONTINUE
      ...
      IF(LUMATCH.EQ.0)THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",6003,&
'INCONSISTENT OR MISSING SOILPARM FILE' )
      ...
      IF ( wrf_dm_on_monitor() ) THEN
        ...
        IF(ierr .NE. OPEN_OK ) THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",6015,&
message )
        END IF

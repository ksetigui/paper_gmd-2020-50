 SUBROUTINE kpp_mechanism_driver( &
    ...
    vdrog3, ldrog, vdrog3_vbs, ldrog_vbs, &
     ...
     USE module_kpp_saprc99_mosaic_4bin_vbs9_interf
     USE module_kpp_racm_esrlsorg_interf
     USE module_kpp_cbmz_sorgam_interf
     USE module_kpp_radm2_interf
     USE module_kpp_racm_soa_vbs_interf
     USE module_kpp_cbmz_mosaic_4bin_vbs9_interf
     ...
     USE module_kpp_mozart_mosaic_4bin_vbs0_interf
     ...
     USE module_kpp_cbmz_mosaic_8bin_vbs9_interf
  ...
  kpp_chem_select: SELECT CASE(config_flags%chem_opt)
   CASE (saprc99_mosaic_4bin_vbs9_kpp)
        CALL wrf_debug(15,'kpp_mechanism_driver: calling saprc99_mosaic_4bin_vbs9_interface')
        CALL saprc99_mosaic_4bin_vbs9_interface( &
    chem, id, dtstepc,config_flags, &
    p_phy,t_phy,rho_phy,moist, &
    vdrog3, ldrog, vdrog3_vbs, ldrog_vbs, &
             addt, addx, addc, etep, oltp, &
   ...
   CASE (cbmz_sorgam_kpp)
        CALL wrf_debug(15,'kpp_mechanism_driver: calling cbmz_sorgam_interface')
        CALL cbmz_sorgam_interface( &
    chem, id, dtstepc,config_flags, &
    p_phy,t_phy,rho_phy,moist, &
    vdrog3, ldrog, vdrog3_vbs, ldrog_vbs, &
             addt, addx, addc, etep, oltp, &
   ...
   CASE (cbmz_mosaic_4bin_vbs9_kpp)
        CALL wrf_debug(15,'kpp_mechanism_driver: calling cbmz_mosaic_4bin_vbs9_interface')
        CALL cbmz_mosaic_4bin_vbs9_interface( &
    chem, id, dtstepc,config_flags, &
    p_phy,t_phy,rho_phy,moist, &
    vdrog3, ldrog, vdrog3_vbs, ldrog_vbs, &
             addt, addx, addc, etep, oltp, &
   ...
   CASE (mozart_mosaic_4bin_vbs0_kpp)
        CALL wrf_debug(15,'kpp_mechanism_driver: calling mozart_mosaic_4bin_vbs0_interface')
        CALL mozart_mosaic_4bin_vbs0_interface( &
    chem, id, dtstepc,config_flags, &
    p_phy,t_phy,rho_phy,moist, &
    vdrog3, ldrog, vdrog3_vbs, ldrog_vbs, &
             addt, addx, addc, etep, oltp, &
   ...
   CASE (cbmz_mosaic_8bin_vbs9_kpp)
        CALL wrf_debug(15,'kpp_mechanism_driver: calling cbmz_mosaic_8bin_vbs9_interface')
        CALL cbmz_mosaic_8bin_vbs9_interface( &
    chem, id, dtstepc,config_flags, &
    p_phy,t_phy,rho_phy,moist, &
    vdrog3, ldrog, vdrog3_vbs, ldrog_vbs, &
             addt, addx, addc, etep, oltp, &

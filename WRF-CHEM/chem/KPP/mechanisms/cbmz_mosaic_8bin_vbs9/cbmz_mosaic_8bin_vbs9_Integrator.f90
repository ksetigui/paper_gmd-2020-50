...
! 
! File                 : cbmz_mosaic_8bin_vbs9_Integrator.f90
...
#ifdef FULL_ALGEBRA    
     CALL cbmz_mosaic_8bin_vbs9_WCOPY(NVAR*NVAR,Jac0,1,Ghimj,1)
     CALL cbmz_mosaic_8bin_vbs9_WSCAL(NVAR*NVAR,(-ONE),Ghimj,1)
...
#ifdef FULL_ALGEBRA    
   CALL  cbmz_mosaic_8bin_vbs9_DGETRF( NVAR, NVAR, A, NVAR, Pivot, ising )
#else   
   CALL cbmz_mosaic_8bin_vbs9_KppDecomp ( A, ising )
   Pivot(1) = 1
#endif
   Ndec = Ndec + 1
...
#ifdef FULL_ALGEBRA    
   CALL  cbmz_mosaic_8bin_vbs9_DGETRS( 'N', NVAR , 1, A, NVAR, Pivot, b, NVAR, 0 )
#else   
...
!!    CALL Update_RCONST()
#ifdef FULL_ALGEBRA    
    CALL cbmz_mosaic_8bin_vbs9_Jac_SP(Y, FIX, RCONST, JV)
    DO j=1,NVAR
      DO i=1,NVAR
         Jcb(i,j) = 0.0d0
      END DO
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! cbmz_mosaic_8bin_vbs9_Fun - time derivatives of variables - Agregate form
!   Arguments :
...
! End of cbmz_mosaic_8bin_vbs9_Fun function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! cbmz_mosaic_8bin_vbs9_Jac_SP - the Jacobian of Variables in sparse matrix representation
!   Arguments :
!      V         - Concentrations of variable species (local)
!      F         - Concentrations of fixed species (local)
!      RCT       - Rate constants (local)
...
! End of cbmz_mosaic_8bin_vbs9_Jac_SP function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! cbmz_mosaic_8bin_vbs9_KppSolve - sparse back substitution
!   Arguments :
!      JVS       - sparse Jacobian of variables
...
! End of cbmz_mosaic_8bin_vbs9_KppSolve function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

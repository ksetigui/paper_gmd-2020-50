MODULE module_kpp_mozart_mosaic_4bin_vbs0_interf
  USE module_state_description
  USE module_configure
  USE mozart_mosaic_4bin_vbs0_Parameters
  USE mozart_mosaic_4bin_vbs0_Precision
  USE mozart_mosaic_4bin_vbs0_UpdateRconstWRF
  USE mozart_mosaic_4bin_vbs0_Integrator
...
CONTAINS
SUBROUTINE mozart_mosaic_4bin_vbs0_interface( &
  ...
  rh = MIN ( MAX ( rh, 0._dp), 1._dp)
   CALL mozart_mosaic_4bin_vbs0_Update_Rconst( &
   rh, &
  ...
  CALL mozart_mosaic_4bin_vbs0_INTEGRATE(TIME_START, TIME_END, &
    ...
    END DO
    END DO
END SUBROUTINE mozart_mosaic_4bin_vbs0_interface
END MODULE module_kpp_mozart_mosaic_4bin_vbs0_interf

...
! 
! File                 : cbmz_mosaic_4bin_vbs9_Main.f90
...
PROGRAM cbmz_mosaic_4bin_vbs9_Driver

  USE cbmz_mosaic_4bin_vbs9_Model
  USE cbmz_mosaic_4bin_vbs9_Initialize, ONLY: Initialize
...
END PROGRAM cbmz_mosaic_4bin_vbs9_Driver

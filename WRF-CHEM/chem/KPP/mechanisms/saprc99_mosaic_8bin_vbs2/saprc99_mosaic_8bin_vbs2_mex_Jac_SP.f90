...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 USE saprc99_mosaic_8bin_vbs2_Model
      ...
      REAL(kind=dp) V(104), F(2), RCT(271)
      REAL(kind=dp) JVS(1146)
...
! Check for the right number of output arguments
     ...
     &JVS(1146)')
      ...
      plhs(1) = mxCreateDoubleMatrix(1146,1,0)
      ...
      RPtr = mxGetPr(prhs(3))
      CALL mxCopyPtrToReal8(RPtr,RCT,271)

      JVSPtr = mxGetPr(plhs(1))

      CALL Jac_SP( V, F, RCT, JVS )

      CALL mxCopyReal8ToPtr(JVS, JVSPtr, 1146)

MODULE module_kpp_saprc99_mosaic_4bin_vbs9_interf
  USE module_state_description
  USE module_configure
  USE saprc99_mosaic_4bin_vbs9_Parameters
  USE saprc99_mosaic_4bin_vbs9_Precision
  USE saprc99_mosaic_4bin_vbs9_UpdateRconstWRF
  USE saprc99_mosaic_4bin_vbs9_Integrator
...
CONTAINS
SUBROUTINE saprc99_mosaic_4bin_vbs9_interface( &
   ...
   RCNTRL(3) = 0.01_dp * TIME_END
    ...
    var(ind_ANT4_o) = conv * REAL( MAX(chem(i,k,j,P_ant4_o),0.), KIND=dp)
   ...
   CALL saprc99_mosaic_4bin_vbs9_Update_Rconst( &
  ...
  CALL saprc99_mosaic_4bin_vbs9_INTEGRATE(TIME_START, TIME_END, &
   ...
   tbu_o(i,k,j) = MAX (REAL (oconv * var(ind_TBU_O) , KIND=sp),0.)
    ...
    chem(i,k,j,P_ant4_o) = MAX ( REAL (oconv * var(ind_ANT4_o), KIND=sp), 0.)
    ...
    END DO
    END DO
END SUBROUTINE saprc99_mosaic_4bin_vbs9_interface
END MODULE module_kpp_saprc99_mosaic_4bin_vbs9_interf

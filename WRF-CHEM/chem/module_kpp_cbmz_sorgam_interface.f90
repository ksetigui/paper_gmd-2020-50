MODULE module_kpp_cbmz_sorgam_interf
  USE module_state_description
  USE module_configure
  USE cbmz_sorgam_Parameters
  USE cbmz_sorgam_Precision
  USE cbmz_sorgam_UpdateRconstWRF
  USE cbmz_sorgam_Integrator
...
CONTAINS
SUBROUTINE cbmz_sorgam_interface( &
   ...
   CALL cbmz_sorgam_Update_Rconst( &
  ...
  CALL cbmz_sorgam_INTEGRATE(TIME_START, TIME_END, &
   ...
   o3p(i,k,j) = MAX (REAL (oconv * var(ind_O3P) , KIND=sp),0.)
    ...
    END DO
    END DO
END SUBROUTINE cbmz_sorgam_interface
END MODULE module_kpp_cbmz_sorgam_interf

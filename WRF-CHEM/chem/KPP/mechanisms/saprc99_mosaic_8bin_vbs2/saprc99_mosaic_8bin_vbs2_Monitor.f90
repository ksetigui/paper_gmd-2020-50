...
MODULE saprc99_mosaic_8bin_vbs2_Monitor
  ...
  CHARACTER(LEN=12), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'ANT4_c      ','BIOG1_c     ','BIOG2_c     ', &
     'BIOG3_c     ','BIOG4_c     ','PSD1        ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '        HO2 + NO2 --> HNO4                                                                          ', &
     '             HNO4 --> HO2 + NO2                                                                     ', &
     '             HNO4 --> 0.61 HO2 + 0.39 NO3 + 0.61 NO2 + 0.39 OH                                      ', &
     '        HNO4 + OH --> NO2                                                                           ', &
     '         O3 + HO2 --> OH                                                                            ', &
     '            2 HO2 --> H2O2                                                                          ', &
     '      2 HO2 + H2O --> H2O2                                                                          ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '        RCHO + OH --> PSD1 + 0.034 CO + 0.034 CCHO + 0.034 RO2_R + 0.965 RCO_O2 + 0.001 RO2_N       ', &
     '             RCHO --> CO + CCHO + RO2_R + HO2                                                       ', &
     '       RCHO + NO3 --> HNO3 + RCO_O2                                                                 ', &
     '        ACET + OH --> PSD1 + R2O2 + HCHO + CCO_O2                                                   ', &
     '             ACET --> CCO_O2 + C_O2                                                                 ', &
     '         MEK + OH --> PSD1 + 0.616 R2O2 + 0.482 CCHO + 0.115 HCHO + 0.37 RCHO + 0.37 RO2_R + 0.492 C', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '    METHACRO + O3 --> 0.333 HCOOH + 0.9 MGLY + 0.45 CO + 0.2 HCHO + 0.1 RO2_R + 0.008 HO2 + 0.1 RCO_', &
     '   METHACRO + NO3 --> 0.5 CO + 0.5 HNO3 + 0.5 RO2_R + 0.5 MA_RCO3                                   ', &
     '   METHACRO + O3P --> RCHO                                                                          ', &
     '         METHACRO --> 0.67 CO + 0.67 HCHO + 0.33 RO2_R + 0.67 CCO_O2 + 0.34 HO2 + 0.33 MA_RCO3 + 0.3', &
     '         MVK + OH --> PSD1 + 0.3 MGLY + 0.675 R2O2 + 0.3 HCHO + 0.675 RCHO + 0.3 RO2_R + 0.675 CCO_O', &
     '         MVK + O3 --> 0.351 HCOOH + 0.95 MGLY + 0.475 CO + 0.1 HCHO + 0.05 RO2_R + 0.064 HO2 + 0.05 ', &
     ...
     '       PROD2 + OH --> PSD1 + 0.084 CCHO + 0.213 HCHO + 0.558 RCHO + 0.115 MEK + 0.329 PROD2 + 0.473 ', &
     '            PROD2 --> 0.515 R2O2 + 0.246 CCHO + 0.506 HCHO + 0.71 RCHO + 0.96 RO2_R + 0.667 CCO_O2 +', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '             DCB2 --> 0.5 MGLY + CO + R2O2 + 0.5 GLY + RO2_R + 0.5 CCO_O2 + 0.5 HO2                 ', &
     '        DCB3 + OH --> PSD1 + R2O2 + RCHO + CCO_O2                                                   ', &
     '             DCB3 --> 0.5 MGLY + CO + R2O2 + 0.5 GLY + RO2_R + 0.5 CCO_O2 + 0.5 HO2                 ', &
     '         CH4 + OH --> PSD1 + C_O2                                                                   ', &
     '      ETHENE + OH --> PSD1 + 0.195 CCHO + 1.61 HCHO + RO2_R                                         ', &
     '      ETHENE + O3 --> 0.37 HCOOH + 0.5 CO + HCHO + 0.12 HO2 + 0.12 OH                               ', &
     '     ETHENE + NO3 --> RCHO + RO2_R                                                                  ', &
     '     ETHENE + O3P --> 0.491 CO + 0.009 GLY + 0.25 CCHO + 0.191 HCHO + 0.2 RO2_R + 0.5 HO2 + 0.3 C_O2', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(1) :: EQN_NAMES_9 = (/ &
     '    PCG2_F_O + OH --> PSD2 + OPCG1_F_O + OH                                                         ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(271) :: EQN_NAMES = (/&

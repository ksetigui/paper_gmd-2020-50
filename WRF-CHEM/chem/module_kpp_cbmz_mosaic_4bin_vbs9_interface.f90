MODULE module_kpp_cbmz_mosaic_4bin_vbs9_interf
  USE module_state_description
  USE module_configure
  USE cbmz_mosaic_4bin_vbs9_Parameters
  USE cbmz_mosaic_4bin_vbs9_Precision
  USE cbmz_mosaic_4bin_vbs9_UpdateRconstWRF
  USE cbmz_mosaic_4bin_vbs9_Integrator
...
CONTAINS
SUBROUTINE cbmz_mosaic_4bin_vbs9_interface( &
   ...
   CALL cbmz_mosaic_4bin_vbs9_Update_Rconst( &
  ...
  CALL cbmz_mosaic_4bin_vbs9_INTEGRATE(TIME_START, TIME_END, &
   ...
   o3p(i,k,j) = MAX (REAL (oconv * var(ind_O3P) , KIND=sp),0.)
    ...
    END DO
    END DO
END SUBROUTINE cbmz_mosaic_4bin_vbs9_interface
END MODULE module_kpp_cbmz_mosaic_4bin_vbs9_interf

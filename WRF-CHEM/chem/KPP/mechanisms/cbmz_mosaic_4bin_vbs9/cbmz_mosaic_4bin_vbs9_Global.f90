...
! 
! File                 : cbmz_mosaic_4bin_vbs9_Global.f90
...
MODULE cbmz_mosaic_4bin_vbs9_Global

  USE cbmz_mosaic_4bin_vbs9_Parameters, ONLY: dp, NSPEC, NVAR, NFIX, NREACT
  PUBLIC
  SAVE
...
END MODULE cbmz_mosaic_4bin_vbs9_Global

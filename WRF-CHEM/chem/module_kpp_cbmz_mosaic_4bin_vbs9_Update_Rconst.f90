MODULE cbmz_mosaic_4bin_vbs9_UpdateRconstWRF
  USE cbmz_mosaic_4bin_vbs9_Parameters
  IMPLICIT NONE
CONTAINS
SUBROUTINE cbmz_mosaic_4bin_vbs9_Update_RCONST( &
...
REAL(KIND=dp), INTENT(IN) :: ch3o2,ethp,ro2,c2o3,ano2,nap,isopp,isopn,isopo2,xo2, &
  ...
  RCONST(209) = (4.0D-11)
  RCONST(210) = (4.0D-11)
END SUBROUTINE cbmz_mosaic_4bin_vbs9_Update_RCONST
  ...
  END FUNCTION TROEE
   ...
   peroxy=RK_PARAM(K)
   END FUNCTION peroxy
END MODULE cbmz_mosaic_4bin_vbs9_UpdateRconstWRF

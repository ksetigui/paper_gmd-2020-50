...
'Error allocating HSESF_TBL in urban_param_init')
         ...
         if(allocate_status /= 0) CALL wrf_error_fatal3("<stdin>",1875,&
'Error allocating ROOF_WIDTH in urban_param_init')
         ...
         if(allocate_status /= 0) CALL wrf_error_fatal3("<stdin>",1881,&

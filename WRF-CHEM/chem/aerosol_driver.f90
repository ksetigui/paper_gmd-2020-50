      ...
      SUBROUTINE aerosols_driver (id,curr_secs,ktau,dtstep,ktauc, &
               ...
               z,z_at_w,pbl_h,cldfra,cldfra_mp_all,vbs_nbin,h2oaj,h2oai,nu3,ac3,cor3,asulf,ahno3,anh3,cvaro1, &
   ...
   CASE (RACMSORG_AQ,RACMSORG_AQCHEM_KPP,RACM_ESRLSORG_AQCHEM_KPP,RACMSORG_KPP,RACM_ESRLSORG_KPP)
       ...
       call sorgam_driver (id,ktauc,dtstepc,t_phy,moist,aerwrf,p8w,t8w, &
               ...
               ims,ime, jms,jme, kms,kme, &
               its,ite, jts,jte, kts,kte )
   CASE (CBMZ_MOSAIC_4BIN, CBMZ_MOSAIC_KPP, CBMZ_MOSAIC_8BIN, CBMZ_MOSAIC_8BIN_VBS9_KPP, CBMZ_MOSAIC_4BIN_AQ, &
         CBMZ_MOSAIC_8BIN_AQ, CBMZ_MOSAIC_4BIN_VBS2_KPP,CBMZ_MOSAIC_4BIN_VBS9_KPP, &
         SAPRC99_MOSAIC_4BIN_VBS9_KPP, MOZART_MOSAIC_4BIN_VBS0_KPP, SAPRC99_MOSAIC_4BIN_VBS2_KPP, &
   ...
   USE module_mosaic_driver, only: sum_pm_mosaic,sum_pm_mosaic_vbs2,sum_pm_mosaic_vbs0,sum_vbs9,sum_vbs2,sum_vbs0,sum_aq_vbs2
   ...
   CASE (CBMZ_MOSAIC_4BIN, CBMZ_MOSAIC_KPP, CBMZ_MOSAIC_8BIN, CBMZ_MOSAIC_4BIN_AQ, CBMZ_MOSAIC_8BIN_AQ, &
         CBMZ_MOSAIC_DMS_4BIN, CBMZ_MOSAIC_DMS_8BIN, CBMZ_MOSAIC_DMS_4BIN_AQ, CBMZ_MOSAIC_DMS_8BIN_AQ, &
         CRI_MOSAIC_8BIN_AQ_KPP, CRI_MOSAIC_4BIN_AQ_KPP,CBMZ_MOSAIC_8BIN_VBS9_KPP, CBMZ_MOSAIC_4BIN_VBS9_KPP )

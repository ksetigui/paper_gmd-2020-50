...
! 
! File                 : cbmz_sorgam_Integrator.f90
! Time                 : Wed Jun 14 17:35:22 2017
! Working directory    : /data/ksetigui/setigui/WRFnew/chem/KPP/mechanisms/cbmz_sorgam
! Equation file        : cbmz_sorgam.kpp
! Output root filename : cbmz_sorgam
! 
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#ifdef FULL_ALGEBRA    
     CALL cbmz_sorgam_WCOPY(NVAR*NVAR,Jac0,1,Ghimj,1)
     CALL cbmz_sorgam_WSCAL(NVAR*NVAR,(-ONE),Ghimj,1)
...
#ifdef FULL_ALGEBRA    
   CALL  cbmz_sorgam_DGETRF( NVAR, NVAR, A, NVAR, Pivot, ising )
#else   
   CALL cbmz_sorgam_KppDecomp ( A, ising )
   Pivot(1) = 1
#endif
   Ndec = Ndec + 1
...
#ifdef FULL_ALGEBRA    
   CALL  cbmz_sorgam_DGETRS( 'N', NVAR , 1, A, NVAR, Pivot, b, NVAR, 0 )
#else   
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   USE cbmz_sorgam_Parameters
!! USE cbmz_sorgam_Global
!! USE cbmz_sorgam_Function
!! USE cbmz_sorgam_Rates
!~~~> Input variables
...
!!    CALL Update_RCONST()
#ifdef FULL_ALGEBRA    
    CALL cbmz_sorgam_Jac_SP(Y, FIX, RCONST, JV)
    DO j=1,NVAR
      DO i=1,NVAR
         Jcb(i,j) = 0.0d0
      END DO
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! cbmz_sorgam_Fun - time derivatives of variables - Agregate form
!   Arguments :
...
! End of cbmz_sorgam_Fun function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! cbmz_sorgam_Jac_SP - the Jacobian of Variables in sparse matrix representation
!   Arguments :
!      V         - Concentrations of variable species (local)
!      F         - Concentrations of fixed species (local)
!      RCT       - Rate constants (local)
...
! End of cbmz_sorgam_Jac_SP function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! cbmz_sorgam_KppSolve - sparse back substitution
!   Arguments :
!      JVS       - sparse Jacobian of variables
...
! End of cbmz_sorgam_KppSolve function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

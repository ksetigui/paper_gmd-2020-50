MODULE saprc99_mosaic_4bin_vbs9_UpdateRconstWRF
  USE saprc99_mosaic_4bin_vbs9_Parameters
  IMPLICIT NONE
CONTAINS
SUBROUTINE saprc99_mosaic_4bin_vbs9_Update_RCONST( &
nume,den, &
                j, nj, &
                RCONST, &
...
REAL(KIND=dp), INTENT(IN) :: nume,den
  ...
  RCONST(231) = (Keff(5.946D-12,91.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(232) = (Keff(1.112D-11,52.0_dp,0.0_dp,TEMP,nume,den,0.064_dp,0.128_dp))
  RCONST(233) = (Keff(1.112D-11,52.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(234) = (Keff(7.095D-12,-451.0_dp,0.0_dp,TEMP,nume,den,0.0002_dp,0.001_dp))
  RCONST(235) = (Keff(7.095D-12,-451.0_dp,0.0_dp,TEMP,nume,den,0.001_dp,0.002_dp))
  RCONST(236) = (Keff(7.095D-12,-451.0_dp,0.0_dp,TEMP,nume,den,0.009_dp,0.015_dp))
  RCONST(237) = (Keff(7.095D-12,-451.0_dp,0.0_dp,TEMP,nume,den,0.037_dp,0.056_dp))
  RCONST(238) = (Keff(7.095D-12,-451.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(239) = (Keff(7.095D-12,-451.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(240) = (Keff(7.095D-12,-451.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(241) = (Keff(7.095D-12,-451.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(242) = (Keff(1.743D-11,-384.0_dp,0.0_dp,TEMP,nume,den,0.0009_dp,0.007_dp))
  RCONST(243) = (Keff(1.743D-11,-384.0_dp,0.0_dp,TEMP,nume,den,0.008_dp,0.014_dp))
  RCONST(244) = (Keff(1.743D-11,-384.0_dp,0.0_dp,TEMP,nume,den,0.026_dp,0.041_dp))
  RCONST(245) = (Keff(1.743D-11,-384.0_dp,0.0_dp,TEMP,nume,den,0.085_dp,0.119_dp))
  RCONST(246) = (Keff(1.743D-11,-384.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(247) = (Keff(1.743D-11,-384.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(248) = (Keff(1.743D-11,-384.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(249) = (Keff(1.743D-11,-384.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(250) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.004_dp,0.004_dp))
  RCONST(251) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.096_dp,0.096_dp))
  RCONST(252) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.181_dp,0.281_dp))
  RCONST(253) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.281_dp,0.281_dp))
  RCONST(254) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(255) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(256) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(257) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(258) = (Keff2(2.640D-11,nume,den,0.005_dp,0.005_dp))
  RCONST(259) = (Keff2(2.640D-11,nume,den,0.109_dp,0.109_dp))
  RCONST(260) = (Keff2(2.640D-11,nume,den,0.205_dp,0.319_dp))
  RCONST(261) = (Keff2(2.640D-11,nume,den,0.319_dp,0.319_dp))
  RCONST(262) = (Keff2(2.640D-11,nume,den,0.0_dp,0.0_dp))
  RCONST(263) = (Keff2(2.640D-11,nume,den,0.0_dp,0.0_dp))
  RCONST(264) = (Keff2(2.640D-11,nume,den,0.0_dp,0.0_dp))
  RCONST(265) = (Keff2(2.640D-11,nume,den,0.0_dp,0.0_dp))
  RCONST(266) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.0003_dp,0.002_dp))
  RCONST(267) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.006_dp,0.008_dp))
  RCONST(268) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.004_dp,0.004_dp))
  RCONST(269) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(270) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(271) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(272) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.007_dp,0.058_dp))
  RCONST(273) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.066_dp,0.050_dp))
  RCONST(274) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.110_dp,0.196_dp))
  RCONST(275) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.272_dp,0.327_dp))
  RCONST(276) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(277) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(278) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(279) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(280) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.061_dp,0.061_dp))
  RCONST(281) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.122_dp,0.122_dp))
  RCONST(282) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.612_dp,0.612_dp))
  RCONST(283) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.734_dp,0.734_dp))
  RCONST(284) = (0.0D0)
  RCONST(285) = (0.0D0)
  RCONST(286) = (0.0D0)
  RCONST(287) = (0.0D0)
  ...
  RCONST(350) = (4.0D-11)
  RCONST(351) = (4.0D-11)
END SUBROUTINE saprc99_mosaic_4bin_vbs9_Update_RCONST
  ...
  END FUNCTION TROEE
   ...
   END FUNCTION THERMAL_T2
    ...
    Keff2 = C0*(y1*X1/(X1 + X2 + 1.0e-35) &
       +y2*(1-X1/(X1 + X2 + 1.0e-35 )))
    END FUNCTION Keff2
END MODULE saprc99_mosaic_4bin_vbs9_UpdateRconstWRF

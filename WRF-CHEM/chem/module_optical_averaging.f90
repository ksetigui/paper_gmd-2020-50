   ...
   CASE (CBMZ_MOSAIC_4BIN, CBMZ_MOSAIC_8BIN , CBMZ_MOSAIC_KPP, &
         ...
         CRI_MOSAIC_4BIN_AQ_KPP, SAPRC99_MOSAIC_4BIN_VBS9_KPP, &
   ...
   real, dimension(1:nbin_o) :: xdia_um, xdia_cm
      ...
      do i = its, ite
        ...
        do isize = 1, nbin_o
          ...
          mass_pom = mass_soa_a1*xmas_sectj(isize)

...
! 
! File                 : mozart_mosaic_4bin_vbs0_Main.f90
...
PROGRAM mozart_mosaic_4bin_vbs0_Driver

  USE mozart_mosaic_4bin_vbs0_Model
  USE mozart_mosaic_4bin_vbs0_Initialize, ONLY: Initialize
...
END PROGRAM mozart_mosaic_4bin_vbs0_Driver

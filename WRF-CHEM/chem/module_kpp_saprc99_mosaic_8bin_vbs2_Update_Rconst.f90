...
REAL(KIND=dp), INTENT(IN) :: nume,den
  ...
  RCONST(228) = (2.20D-10)
  RCONST(229) = (7.0D-7)
  RCONST(230) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.13268_dp))
  RCONST(231) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.01401_dp,0.0_dp))
  RCONST(232) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.02875_dp,0.0_dp))
  RCONST(233) = (Keff(1.81D-12,-355.0_dp,0.0_dp,TEMP,nume,den,0.03833_dp,0.0_dp))
  RCONST(234) = (Keff2(2.640D-11,nume,den,0.0_dp,0.12739_dp))
  RCONST(235) = (Keff2(2.640D-11,nume,den,0.01231_dp,0.0_dp))
  RCONST(236) = (Keff2(2.640D-11,nume,den,0.00934_dp,0.0_dp))
  RCONST(237) = (Keff2(2.640D-11,nume,den,0.04756_dp,0.0_dp))
  RCONST(238) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.00109_dp))
  RCONST(239) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.00518_dp,0.00518_dp))
  RCONST(240) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.01717_dp,0.00872_dp))
  RCONST(241) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.01853_dp,0.14986_dp))
  RCONST(242) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.10845_dp,0.05450_dp))
  RCONST(243) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.09264_dp))
  RCONST(244) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.01020_dp))
  RCONST(245) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.99144_dp,0.65688_dp))
  RCONST(246) = (Keff(7.86D-15,1912.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.00327_dp))
  RCONST(247) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.00327_dp,0.02616_dp))
  RCONST(248) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.00872_dp))
  RCONST(249) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.13134_dp,0.14114_dp))
  RCONST(250) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.00490_dp,0.03917_dp))
  RCONST(251) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.01306_dp))
  RCONST(252) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.19666_dp,0.21134_dp))
  RCONST(253) = (Keff3(3.03D-12,448.0_dp,0.0_dp,TEMP,0.00027_dp))
  RCONST(254) = (Keff3(3.03D-12,448.0_dp,0.0_dp,TEMP,0.04060_dp))
  RCONST(255) = (Keff3(3.03D-12,448.0_dp,0.0_dp,TEMP,0.06458_dp))
  RCONST(256) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.17493_dp))
  RCONST(257) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.59019_dp))
  RCONST(258) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.26194_dp))
  RCONST(259) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.88373_dp))
  RCONST(260) = (0.0D0)
  RCONST(261) = (0.0D0)
  RCONST(262) = (0.0D0)
  RCONST(263) = (0.0D0)
  ...
  RCONST(266) = (0.0D0)
  RCONST(267) = (0.0D0)
  RCONST(268) = (0.5714D-11)
  RCONST(269) = (0.5714D-11)
  RCONST(270) = (0.5714D-11)
  RCONST(271) = (0.5714D-11)

...
"Namelist parameter DVEG unknown")
    ...
    EDIR = QVAP - QDEW
     CALL WATER (VEGTYP ,NSNOW ,NSOIL ,IMELT ,DT ,UU , &
                 ...
                 FICEOLD,PONDING,TG ,IST ,FVEG ,iloc,jloc , &
  ...
  ENDIF
     ...
     ELAI = LAI*(1.-FB)
     ESAI = SAI*(1.-FB)
     IF (ESAI < 0.1) ESAI = 0.0
     IF (ELAI < 0.1 .OR. ESAI == 0.0) ELAI = 0.0

...
! 
! File                 : mozart_mosaic_4bin_vbs0_Global.f90
...
MODULE mozart_mosaic_4bin_vbs0_Global

  USE mozart_mosaic_4bin_vbs0_Parameters, ONLY: dp, NSPEC, NVAR, NFIX, NREACT
  PUBLIC
  SAVE
...
END MODULE mozart_mosaic_4bin_vbs0_Global

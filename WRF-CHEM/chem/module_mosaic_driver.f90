...
2920 continue
 ...
 return
   ...
   do itype=1,ntype_aer
        ...
        arosoa_a01(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_ant2_c_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_ant3_c_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_ant4_c_aer(1,itype,iphase))
        biog_a01(i,k,j)= chem(i,k,j,lptr_biog1_c_aer(1,itype,iphase)) &
   ...
   do itype=1,ntype_aer
        ...
        arosoa_a02(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_ant2_c_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_ant3_c_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_ant4_c_aer(2,itype,iphase))
        biog_a02(i,k,j)= chem(i,k,j,lptr_biog1_c_aer(2,itype,iphase)) &
   ...
   do itype=1,ntype_aer
        ...
        arosoa_a03(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_ant2_c_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_ant3_c_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_ant4_c_aer(3,itype,iphase))
        biog_a03(i,k,j)= chem(i,k,j,lptr_biog1_c_aer(3,itype,iphase)) &
   ...
   do itype=1,ntype_aer
        ...
        arosoa_a04(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_ant2_c_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_ant3_c_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_ant4_c_aer(4,itype,iphase))
        biog_a04(i,k,j)= chem(i,k,j,lptr_biog1_c_aer(4,itype,iphase)) &
   ...
   do itype=1,ntype_aer
         ...
         bbsoa_a05(i,j,j)=0.0
          soa_a05(i,k,j)= &
                       ...
                       + chem(i,k,j,lptr_ant2_c_aer(5,itype,iphase)) &
                       + chem(i,k,j,lptr_ant3_c_aer(5,itype,iphase)) &
                       + chem(i,k,j,lptr_ant4_c_aer(5,itype,iphase)) &
                       + chem(i,k,j,lptr_biog1_c_aer(5,itype,iphase)) &
                       + chem(i,k,j,lptr_biog2_c_aer(5,itype,iphase)) &
                       + chem(i,k,j,lptr_biog3_c_aer(5,itype,iphase)) &
                       + chem(i,k,j,lptr_biog4_c_aer(5,itype,iphase))
        arosoa_a05(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(5,itype,iphase)) &
                       + chem(i,k,j,lptr_ant2_c_aer(5,itype,iphase)) &
                       + chem(i,k,j,lptr_ant3_c_aer(5,itype,iphase)) &
                       + chem(i,k,j,lptr_ant4_c_aer(5,itype,iphase))
   ...
   do itype=1,ntype_aer
         ...
         bbsoa_a06(i,j,j)=0.0
          soa_a06(i,k,j)= &
                       ...
                       + chem(i,k,j,lptr_ant2_c_aer(6,itype,iphase)) &
                       + chem(i,k,j,lptr_ant3_c_aer(6,itype,iphase)) &
                       + chem(i,k,j,lptr_ant4_c_aer(6,itype,iphase)) &
                       + chem(i,k,j,lptr_biog1_c_aer(6,itype,iphase)) &
                       + chem(i,k,j,lptr_biog2_c_aer(6,itype,iphase)) &
                       + chem(i,k,j,lptr_biog3_c_aer(6,itype,iphase)) &
                       + chem(i,k,j,lptr_biog4_c_aer(6,itype,iphase))
        arosoa_a06(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(6,itype,iphase)) &
                       + chem(i,k,j,lptr_ant2_c_aer(6,itype,iphase)) &
                       + chem(i,k,j,lptr_ant3_c_aer(6,itype,iphase)) &
                       + chem(i,k,j,lptr_ant4_c_aer(6,itype,iphase))
   ...
   do itype=1,ntype_aer
         ...
         bbsoa_a07(i,j,j)=0.0
          soa_a07(i,k,j)= &
                       ...
                       + chem(i,k,j,lptr_ant2_c_aer(7,itype,iphase)) &
                       + chem(i,k,j,lptr_ant3_c_aer(7,itype,iphase)) &
                       + chem(i,k,j,lptr_ant4_c_aer(7,itype,iphase)) &
                       + chem(i,k,j,lptr_biog1_c_aer(7,itype,iphase)) &
                       + chem(i,k,j,lptr_biog2_c_aer(7,itype,iphase)) &
                       + chem(i,k,j,lptr_biog3_c_aer(7,itype,iphase)) &
                       + chem(i,k,j,lptr_biog4_c_aer(7,itype,iphase))
        arosoa_a07(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(7,itype,iphase)) &
                       + chem(i,k,j,lptr_ant2_c_aer(7,itype,iphase)) &
                       + chem(i,k,j,lptr_ant3_c_aer(7,itype,iphase)) &
                       + chem(i,k,j,lptr_ant4_c_aer(7,itype,iphase))
   ...
   do itype=1,ntype_aer
         ...
         bbsoa_a08(i,j,j)=0.0
          soa_a08(i,k,j)= &
                       ...
                       + chem(i,k,j,lptr_ant2_c_aer(8,itype,iphase)) &
                       + chem(i,k,j,lptr_ant3_c_aer(8,itype,iphase)) &
                       + chem(i,k,j,lptr_ant4_c_aer(8,itype,iphase)) &
                       + chem(i,k,j,lptr_biog1_c_aer(8,itype,iphase)) &
                       + chem(i,k,j,lptr_biog2_c_aer(8,itype,iphase)) &
                       + chem(i,k,j,lptr_biog3_c_aer(8,itype,iphase)) &
                       + chem(i,k,j,lptr_biog4_c_aer(8,itype,iphase))
        arosoa_a08(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(8,itype,iphase)) &
                       + chem(i,k,j,lptr_ant2_c_aer(8,itype,iphase)) &
                       + chem(i,k,j,lptr_ant3_c_aer(8,itype,iphase)) &
                       + chem(i,k,j,lptr_ant4_c_aer(8,itype,iphase))
  ...
  if (aboxtest_gases_fixed .eq. 10) then
      if ((l .eq. kh2so4 ) .or. (l .eq. khno3 ) .or. &
          ...
          (l .eq. kpan ) .or. &
                        ...
                        (l .eq. kbiog3_o ) .or. (l .eq. kbiog4_o )) then
   ido_l = 0
      end if
  end if
  if (ido_l .gt. 0) then
 ...
 if (nsize_aer(itype) .ge. 1) then
   if (cw_phase .gt. 0) then
     ...
     lptr_bc_aer(01,itype,cw_phase) = p_bc_cw01
            ...
            lptr_ant2_c_aer(01,itype,cw_phase) = p_ant2_c_cw01
            lptr_ant3_c_aer(01,itype,cw_phase) = p_ant3_c_cw01
            lptr_ant4_c_aer(01,itype,cw_phase) = p_ant4_c_cw01
            lptr_biog1_c_aer(01,itype,cw_phase) = p_biog1_c_cw01
            lptr_biog2_c_aer(01,itype,cw_phase) = p_biog2_c_cw01
            lptr_biog3_c_aer(01,itype,cw_phase) = p_biog3_c_cw01
            lptr_biog4_c_aer(01,itype,cw_phase) = p_biog4_c_cw01
 ...
 if (nsize_aer(itype) .ge. 2) then
   if (cw_phase .gt. 0) then
     ...
     lptr_bc_aer(02,itype,cw_phase) = p_bc_cw02
            ...
            lptr_ant2_c_aer(02,itype,cw_phase) = p_ant2_c_cw02
            lptr_ant3_c_aer(02,itype,cw_phase) = p_ant3_c_cw02
            lptr_ant4_c_aer(02,itype,cw_phase) = p_ant4_c_cw02
            lptr_biog1_c_aer(02,itype,cw_phase) = p_biog1_c_cw02
            lptr_biog2_c_aer(02,itype,cw_phase) = p_biog2_c_cw02
            lptr_biog3_c_aer(02,itype,cw_phase) = p_biog3_c_cw02
            lptr_biog4_c_aer(02,itype,cw_phase) = p_biog4_c_cw02
 ...
 if (nsize_aer(itype) .ge. 3) then
   if (cw_phase .gt. 0) then
     ...
     lptr_bc_aer(03,itype,cw_phase) = p_bc_cw03
            ...
            lptr_ant2_c_aer(03,itype,cw_phase) = p_ant2_c_cw03
            lptr_ant3_c_aer(03,itype,cw_phase) = p_ant3_c_cw03
            lptr_ant4_c_aer(03,itype,cw_phase) = p_ant4_c_cw03
            lptr_biog1_c_aer(03,itype,cw_phase) = p_biog1_c_cw03
            lptr_biog2_c_aer(03,itype,cw_phase) = p_biog2_c_cw03
            lptr_biog3_c_aer(03,itype,cw_phase) = p_biog3_c_cw03
            lptr_biog4_c_aer(03,itype,cw_phase) = p_biog4_c_cw03
 ...
 if (nsize_aer(itype) .ge. 4) then
   if (cw_phase .gt. 0) then
     ...
     lptr_bc_aer(04,itype,cw_phase) = p_bc_cw04
            ...
            lptr_ant2_c_aer(04,itype,cw_phase) = p_ant2_c_cw04
            lptr_ant3_c_aer(04,itype,cw_phase) = p_ant3_c_cw04
            lptr_ant4_c_aer(04,itype,cw_phase) = p_ant4_c_cw04
            lptr_biog1_c_aer(04,itype,cw_phase) = p_biog1_c_cw04
            lptr_biog2_c_aer(04,itype,cw_phase) = p_biog2_c_cw04
            lptr_biog3_c_aer(04,itype,cw_phase) = p_biog3_c_cw04
            lptr_biog4_c_aer(04,itype,cw_phase) = p_biog4_c_cw04
 ...
 if (nsize_aer(itype) .ge. 5) then
   if (cw_phase .gt. 0) then
     ...
     lptr_bc_aer(05,itype,cw_phase) = p_bc_cw05
            ...
            lptr_ant2_c_aer(05,itype,cw_phase) = p_ant2_c_cw05
            lptr_ant3_c_aer(05,itype,cw_phase) = p_ant3_c_cw05
            lptr_ant4_c_aer(05,itype,cw_phase) = p_ant4_c_cw05
            lptr_biog1_c_aer(05,itype,cw_phase) = p_biog1_c_cw05
            lptr_biog2_c_aer(05,itype,cw_phase) = p_biog2_c_cw05
            lptr_biog3_c_aer(05,itype,cw_phase) = p_biog3_c_cw05
            lptr_biog4_c_aer(05,itype,cw_phase) = p_biog4_c_cw05
 ...
 if (nsize_aer(itype) .ge. 6) then
   if (cw_phase .gt. 0) then
     ...
     lptr_bc_aer(06,itype,cw_phase) = p_bc_cw06
            ...
            lptr_ant2_c_aer(06,itype,cw_phase) = p_ant2_c_cw06
            lptr_ant3_c_aer(06,itype,cw_phase) = p_ant3_c_cw06
            lptr_ant4_c_aer(06,itype,cw_phase) = p_ant4_c_cw06
            lptr_biog1_c_aer(06,itype,cw_phase) = p_biog1_c_cw06
            lptr_biog2_c_aer(06,itype,cw_phase) = p_biog2_c_cw06
            lptr_biog3_c_aer(06,itype,cw_phase) = p_biog3_c_cw06
            lptr_biog4_c_aer(06,itype,cw_phase) = p_biog4_c_cw06
 ...
 if (nsize_aer(itype) .ge. 7) then
   if (cw_phase .gt. 0) then
     ...
     lptr_bc_aer(07,itype,cw_phase) = p_bc_cw07
            ...
            lptr_ant2_c_aer(07,itype,cw_phase) = p_ant2_c_cw07
            lptr_ant3_c_aer(07,itype,cw_phase) = p_ant3_c_cw07
            lptr_ant4_c_aer(07,itype,cw_phase) = p_ant4_c_cw07
            lptr_biog1_c_aer(07,itype,cw_phase) = p_biog1_c_cw07
            lptr_biog2_c_aer(07,itype,cw_phase) = p_biog2_c_cw07
            lptr_biog3_c_aer(07,itype,cw_phase) = p_biog3_c_cw07
            lptr_biog4_c_aer(07,itype,cw_phase) = p_biog4_c_cw07
 ...
 if (nsize_aer(itype) .ge. 8) then
   if (cw_phase .gt. 0) then
     ...
     lptr_bc_aer(08,itype,cw_phase) = p_bc_cw08
            ...
            lptr_ant2_c_aer(08,itype,cw_phase) = p_ant2_c_cw08
            lptr_ant3_c_aer(08,itype,cw_phase) = p_ant3_c_cw08
            lptr_ant4_c_aer(08,itype,cw_phase) = p_ant4_c_cw08
            lptr_biog1_c_aer(08,itype,cw_phase) = p_biog1_c_cw08
            lptr_biog2_c_aer(08,itype,cw_phase) = p_biog2_c_cw08
            lptr_biog3_c_aer(08,itype,cw_phase) = p_biog3_c_cw08
            lptr_biog4_c_aer(08,itype,cw_phase) = p_biog4_c_cw08

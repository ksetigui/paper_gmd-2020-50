...
' lightning_init: Selected lightning option requires microphysics and do_radar_ref=1' )
    ...
    CASE (ltng_cpm_PR92z)
        IF ( cu_physics .ne. GDSCHEME .and. cu_physics .ne. G3SCHEME .and. cu_physics .ne. KFCUPSCHEME) THEN
          CALL wrf_error_fatal3("<stdin>",128,&
' lightning_init: Selected lightning option requires KFCUP, GD or G3 convective parameterization' )
        ENDIF
